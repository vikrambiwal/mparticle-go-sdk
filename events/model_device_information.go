...
type DeviceInformation struct {
	...
	ATTTimestampUnixtimeMS         int64                  `json:"att_timestamp_unixtime_ms,omitempty"`
	ATTAuthorizationStatus         ATTAuthorizationStatus `json:"att_authorization_status,omitempty"`

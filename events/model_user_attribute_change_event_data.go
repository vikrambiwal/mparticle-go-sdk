...
package events
// UserAttributeChangeEventData struct for UserAttributeChangeEventData
type UserAttributeChangeEventData struct {
	...
	UserAttributeName string `json:"user_attribute_name"`
	New map[string]interface{} `json:"new"`
	Old map[string]interface{} `json:"old"`
	Deleted bool `json:"deleted"`
	IsNewAttribute bool `json:"is_new_attribute"`
}

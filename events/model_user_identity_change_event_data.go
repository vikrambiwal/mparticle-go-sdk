...
package events
// UserIdentityChangeEventData struct for UserIdentityChangeEventData
type UserIdentityChangeEventData struct {
	...
	New UserIdentity `json:"new"`
	Old UserIdentity `json:"old"`
}

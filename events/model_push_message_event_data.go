...
package events
// PushMessageEventData struct for PushMessageEventData
type PushMessageEventData struct {
	...
	PushMessageToken string `json:"push_message_token"`
	PushMessageEventType string `json:"push_message_type"`
	Message string `json:"message,omitempty"`
	Network string `json:"network,omitempty"`
	PushNotificationPayload string `json:"push_notification_payload"`
	ApplicationState string `json:"application_state,omitempty"`
	ActionIdentifier string `json:"action_identifier,omitempty"`
	PushMessageBehavior string `json:"push_message_behavior,omitempty"`
}
